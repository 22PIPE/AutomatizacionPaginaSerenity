...
import co.com.choucair.certification.serenity_automatizacion.userinterface.PaginaNuevaReunion;
...
public class NewReunion implements Task {
    ...
    public <T extends Actor> void performAs(T actor) {
        actor.attemptsTo(Enter.theValue("Prueba1").into(PaginaNuevaReunion.INPUT_NAME_NUEVA_REUNION),
                ...
                Enter.theValue("01/03/2023").into(PaginaNuevaReunion.INPUT_DATE_FECHA_INICIAL),
                ...
                Enter.theValue("01/03/2023").into(PaginaNuevaReunion.INPUT_DATE_FECHA_FINAL),
